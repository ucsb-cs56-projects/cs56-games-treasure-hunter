...
public class GameComponent extends JComponent
{
    ...
    ArrayList<Treasure> theTreasures, theTreasures2;
    ...
    public void paintComponent(Graphics g) {
        ...
        if(mode == 2) {
            for(int i = 0; i < tilesHeight; i++) {
                for(int j = 0; j < tilesWidth; j++) {
                    switch(tiletypes[i][j]) {
                        case 'G':
                            g.drawImage(grassTile, j * 50 + 608, i * 50, null);
                            break;
                        case 'B':
                            g.drawImage(bushTile, j * 50 + 608, i * 50, null);
                            break;
                        case 'S':
                            g.drawImage(stoneTile, j * 50 + 608, i * 50, null);
                            break;
                    }
                }
            }
        ...
        if(mode == 2) g.drawImage(player2.getCurrentImage(), player2.getXPos() + 608, player2.getYPos(), null);
    ...
    public void loadPlayer2(Player player2) {
    ...
    public void placeTheTreasures(int howMany) {
        ...
        treasureMap2 = new int[tilesHeight][tilesWidth];
        theTreasures = new ArrayList<Treasure>();
        theTreasures2 = new ArrayList<Treasure>();
