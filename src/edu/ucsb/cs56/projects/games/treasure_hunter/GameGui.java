...
{
    Player player;
    Treasure treasure1 = new Treasure("treasure1");
    Treasure treasure2 = new Treasure("treasure2");
    Treasure treasure3 = new Treasure("treasure3");
	...
	player = new Player(0,0,16,8,"player");
 	...
 	int treasure1X = treasure1.getXTile();
	int treasure1Y = treasure1.getYTile();

  int treasure2X = treasure2.getXTile();
	int treasure2Y = treasure2.getYTile();

  int treasure3X = treasure3.getXTile();
	int treasure3Y = treasure3.getYTile();
	...
	component.loadTreasure(treasure2, "treasure2");
	component.loadTreasure(treasure3,"treasure3");
